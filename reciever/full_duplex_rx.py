#this is full duplex code for messaging if you want to perform the chatting full duplex for the reciever side
#then this code is for that 
...
ap.active(True)
ap.config(essid='LoRaReciever', password='lorapassword')
