...
class SX1262(SX126X):
    ...
    def begin(self, freq=865.0625, bw=125.0, sf=9, cr=7, syncWord=SX126X_SYNC_WORD_PRIVATE,
    ...
    def beginFSK(self, freq=865.0625, br=125.0, freqDev=62.5, rxBw=156.2, power=14, currentLimit=60.0,
